...
from sufdo.utils import (
    ...
    validate_command, get_os_package_manager
)
...
class TestColors(unittest.TestCase):
    ...
    def test_colors_use_slots(self):
        """Test that Colors uses __slots__."""
        self.assertFalse(hasattr(Colors, '__dict__'))
...
class TestRainbowText(unittest.TestCase):
    ...
    def test_rainbow_text_preserves_content(self):
        """Test that rainbow text preserves content."""
        result = rainbow_text("test")
